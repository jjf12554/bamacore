(function ($) {
    $.nfinetab = {
        ...
        refreshTab: function () {
            ...
            var target = $('.BAMA_iframe[data-id="' + currentId + '"]');
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent .BAMA_iframe').each(function () {
                    if ($(this).data('id') == currentId) {
                        $(this).show().siblings('.BAMA_iframe').hide();
                        return false;
                    }
                });
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-remove').parents('a').not(".active").each(function () {
                $('.BAMA_iframe[data-id="' + $(this).data('id') + '"]').remove();
                $(this).remove();
            });
        ...
        addTab: function () {
            ...
            if (dataId != "") {
                top.$.cookie('jxbama_currentmoduleid', dataId, { path: "/" });
            }
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="BAMA_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
                $('.mainContent').find('iframe.BAMA_iframe').hide();
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                ...
                $('.page-tabs-content').children("[data-id]:first").each(function () {
                    $('.BAMA_iframe[data-id="' + $(this).data('id') + '"]').show();
